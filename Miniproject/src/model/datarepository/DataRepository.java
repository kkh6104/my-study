...
public class DataRepository {
	...
	public void reName(String userID, User currentUser) {
		users.put(userID, currentUser);
		uploadUsers(users);
	}

	public void reAge(String userID, User currentUser) {
		users.put(userID, currentUser);
		uploadUsers(users);
	}
	

	public void topup(String userID, User currentUser) {
		users.put(userID, currentUser);
		uploadUsers(users);
	}

	public void register(String userID, User currentUser) {
		users.put(userID, currentUser);
		uploadUsers(users);
	}
