...
public class Service {
	...
	public String register(String userID, String name, int age) {
		...
		dr.register(userID, currentUser);
		return userID;
	}
	...
	public void reName(String name) {
		...
		dr.register(currentUser.getUserID(), currentUser);
	}
	...
	public String topup(int money) throws MinusMoneyException{
		...
		dr.topup(currentUser.getUserID(), currentUser);
		return ""+currentUser.getBalance();
	}
	...
	public String streaming(String ContetID) throws LackOfBalanceException, AgeLimitException, NotFoundContentsException {

		Content selectedOne = null;
		for (Content i : dr.showAllContentsList()) {
			if ((i.getContentID()).equals(ContetID)) selectedOne = i;
